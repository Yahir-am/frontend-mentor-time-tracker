...
const previously = document.querySelectorAll(".previously-time");
...
async function getDaily(){
    ...
    .then(data => {
        current.forEach((element,i) => {
            ...
            previously[i].innerHTML = `Last Daily - ${data[i].timeframes.daily.previous}hrs`;
        })
    })
...
async function getMonthly(){
    ...
    .then(data => {
        current.forEach((element,i) => {
            ...
            previously[i].innerHTML = `Last Daily - ${data[i].timeframes.monthly.previous}hrs`;
        })
    })
...
async function getWeekly(){
    ...
    .then(data => {
        current.forEach((element,i) => {
            ...
            previously[i].innerHTML = `Last Daily - ${data[i].timeframes.weekly.previous}hrs`;
        })
    })
    daily.classList.remove('active');
    monthly.classList.remove('active');
